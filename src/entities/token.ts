...
export class Token extends Currency {
  ...
  public constructor(chainId: ChainId, address: string, decimals: number, symbol?: string, name?: string, isUnderlying?: number, isCrossChain?: number) {
    super(decimals, symbol, name, isUnderlying, isCrossChain)
